...
describe('calculateStatsLA', () => {
  ...
  it('produces higher atk under a beneficial atk nature than a neutral one', () => {
    ...
    const beneficial = calculateStatsLA(
      base,
      ZERO_STATS,
      ZERO_STATS,
      50,
