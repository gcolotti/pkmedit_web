...
import type { CatalogBundle, CatalogEntry } from './catalogs'
export type { CatalogBundle, CatalogEntry }

import type { InventoryItemEntry, ItemBag, ItemPocket } from './items'
...
import type { MoveDetail } from './moveDetail'
