import { localizedText } from '../../core/i18n/i18n'
import { getCatalogEntryOptionStyle } from '../../core/utils/catalogStyle'
import { getMoveEffectChanges } from '../../core/utils/generationData'
import {
  renderCategoryStat,
  renderMoveEffectInCombat,
} from '../../core/utils/generationRendering'
import { getActiveFlags } from '../../core/utils/moveFlags'
import {
  ...
  humanizeSlug,
  itemModifierLabel,
} from '../../core/utils/moveFormatters'
import {
  extractSecondaryEffect,
  formatStructuredSecondaryEffects,
  getSourceUrls,
} from '../../core/utils/moveParsers'
import { renderEffect, renderStat } from '../../core/utils/moveRenderers'
import { TypeIcon } from '../ui/TypeIcon'
import { MoveCardFlags } from './MoveCardFlags'
import { MoveCardModifiers } from './MoveCardModifiers'
import { MoveCardSecondaryEffects } from './MoveCardSecondaryEffects'
import { MoveCardSources } from './MoveCardSources'
import type { MoveDetailCardProps } from './MoveDetailCardTypes'
