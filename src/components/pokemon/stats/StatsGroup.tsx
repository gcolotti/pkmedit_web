...
import type { PokemonEffortKind } from '../../../core/types/index'
import type {
  PokemonHyperTrain,
  PokemonStats,
} from '../../../core/types/pokemon'
import type { NatureModifier } from '../../../core/utils/natureData'
import { getMaxGv } from '../../../core/utils/statCalc'
import { EditorGroup } from '../../core/EditorGroup'
import { useFieldIssue } from '../../core/forms/FieldIssueContext'
import { EffortInputGroup } from './StatsEffortInputGroup'
import {
  effortLabelKey,
  getStatsGridCols,
  headerClassName,
  ...
  suggestGvs,
  updateEffortStats,
} from './StatsGroupControls'
import { IvInputGroup } from './StatsIvInputGroup'
import { StatsTotalRow } from './StatsTotalRow'
