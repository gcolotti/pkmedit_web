...
import { ArceusResearchPanel } from '../ArceusResearchPanel/ArceusResearchPanel'
import { ArceusResearchRegionView } from '../ArceusResearchRegionView/ArceusResearchRegionView'
