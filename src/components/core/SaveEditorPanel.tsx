import type { SaveView } from '../../core/types/index'
import { ItemBagEditor } from '../items/ItemBagEditor'
import { UndergroundItemsPanel } from '../items/underground/UndergroundItemsPanel'
import { MetDateFixerPanel } from '../pokemon/met-date/MetDateFixerPanel'
import { PokedexPanel } from '../pokemon/pokedex/PokedexPanel'
import { TrainerInfoEditor } from '../trainer/TrainerInfoEditor'
import { SubPanelTabs } from '../ui/SubPanelTabs'
import type { SaveEditorPanelProps } from './SaveEditorPanelTypes'
